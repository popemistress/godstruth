...
export default function LoginPage() {
  ...
  return (
    <>
      <h1 className="font-serif text-2xl font-bold text-neutral-80 mb-1">Welcome back</h1>
      <p className="text-sm text-neutral-45 mb-6">Sign in to continue your study.</p>
      ...
      <p className="text-center text-sm text-neutral-45 mt-6">
        ...
        <Link href="/register" className="text-brand-accessible font-medium hover:underline">Create one</Link>
      </p>
    </>
  );
}
